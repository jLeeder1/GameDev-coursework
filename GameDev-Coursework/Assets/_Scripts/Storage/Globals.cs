...
public class Globals : MonoBehaviour
{
	...
	public const string APPLICATION_ID = "BDF5EEE0-16C7-5A29-FF91-EDF335C23900"; // you need to add your OWN id here!!
	public const string REST_SECRET_KEY = "347BF7C1-C3BB-47EF-A1C4-7D60C88CCD6B"; // you need to add your OWN key here!!
